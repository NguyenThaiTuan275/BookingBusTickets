...
const Routes = () => {
    ...
    const loadData = async () => {
        try {
            ...
            if (response.success) {
                const routesData = response.responseObject?.results || [];
    ...
    const loadStations = async () => {
        try {
            ...
            if (response.success) {
                setStations(response.responseObject || []);
            }
        } catch (error) {
                                ...
                                <CTableBody>
                                    {routes.map((route, index) => (
                                        <CTableRow key={route.id}>
                                            ...
                                            <CTableDataCell>
                                                <strong>{getStationName(route.departure_station_id)}</strong>
                                            </CTableDataCell>
                                            <CTableDataCell>
                                                <strong>{getStationName(route.arrival_station_id)}</strong>
                                            </CTableDataCell>
                                            <CTableDataCell>
